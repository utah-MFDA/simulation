...
# place_pin -pin_name pin_15 -layer met4 -location {1320 930} -pin_size {1 1}
# place_pin -pin_name pin_16 -layer met4 -location {1410 930} -pin_size {1 1}
...
# place_pin -pin_name pin_25 -layer met4 -location {1320 840} -pin_size {1 1}
# place_pin -pin_name pin_26 -layer met4 -location {1410 840} -pin_size {1 1}
...
# place_pin -pin_name pin_35 -layer met4 -location {1320 750} -pin_size {1 1}
# place_pin -pin_name pin_36 -layer met4 -location {1410 750} -pin_size {1 1}
# place_pin -pin_name pin_37 -layer met4 -location {1500 750} -pin_size {1 1}
# place_pin -pin_name pin_38 -layer met4 -location {1590 750} -pin_size {1 1}

# place_pin -pin_name pin_41 -layer met4 -location {960 660} -pin_size {1 1}
# place_pin -pin_name pin_42 -layer met4 -location {1050 660} -pin_size {1 1}
# place_pin -pin_name pin_43 -layer met4 -location {1140 660} -pin_size {1 1}
# place_pin -pin_name pin_44 -layer met4 -location {1230 660} -pin_size {1 1}
