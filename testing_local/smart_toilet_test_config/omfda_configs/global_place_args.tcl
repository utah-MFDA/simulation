...
set bin_grid_count 20

# placement density p_t
set place_density 0.85

# Set initial density penalty. Default: 8e-5 [1e-6 - 1e6, float]
set init_density_penalty 1e-2

# Set initial wirelength coefficient. Default: 0.25 [unlimited, float]
set init_wirelength_coef 1e4
...
set initial_place_max_fanout 200
